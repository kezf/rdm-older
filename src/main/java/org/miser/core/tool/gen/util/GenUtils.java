package org.miser.core.tool.gen.util;

import org.apache.velocity.VelocityContext;
import org.miser.common.constant.CommonMap;
...
public class GenUtils {
     ...
     * 项目空间路径
     */
    private static final String sourcePath = "main/java";
    ...
    public static String getFileName(String template, TableInfo table, String modulePath, String moduleName) {
        ...
        // 大写类名
        String className = table.getClassName();
        String javaPath = sourcePath + "/" + modulePath + "/";
