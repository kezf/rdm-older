package org.miser.core.monitor.logininfor.service;

import java.util.List;

import org.miser.common.support.Convert;
import org.miser.core.monitor.logininfor.domain.Logininfor;
import org.miser.core.monitor.logininfor.mapper.LogininforMapper;
...
public class LogininforServiceImpl implements ILogininforService
{
     ...
     */
    @Override
    public int truncateLogininfor() {
        logininforMapper.truncateLogininfor();
        return 1;
    }
}
